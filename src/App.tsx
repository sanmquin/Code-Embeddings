          ...
          <header>
            ...
            <div style={{ display: 'flex', gap: '10px', marginBottom: '20px' }}>
              <button
                ...
                className={trainingMode === 'single' ? 'active' : ''}
                style={{
                  backgroundColor: trainingMode === 'single' ? '#2196F3' : '#333',
                  color: '#fff',
                  border: 'none',
                  padding: '10px 20px',
                  borderRadius: '4px',
              ...
              <button
                ...
                className={trainingMode === 'batch' ? 'active' : ''}
                style={{
                  backgroundColor: trainingMode === 'batch' ? '#2196F3' : '#333',
                  color: '#fff',
                  border: 'none',
                  padding: '10px 20px',
                  borderRadius: '4px',
